...
Number(function ($) {
  ...
  Modal.prototype.show = function (_relatedTarget) {
    ...
    const e = $.Event('show.nth.modal', {relatedTarget: _relatedTarget});
    ...
    this.backdrop(function () {
      ...
      const e = $.Event('shown.nth.modal', {relatedTarget: _relatedTarget});
  ...
  $(document).on('click.nth.modal.data-api', '[data-toggle="modal"]', function (e) {
    ...
    const option = $target.data('nth.modal') ? 'toggle' : $.extend({remote: !/#/.test(href) && href}, $target.data(), $this.data());
